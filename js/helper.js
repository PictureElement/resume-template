...
var HTMLworkEmployer = '<a href="%data1%">%data2%';
...
var HTMLprojectTitle = '<a href="%data1%">%data2%</a>';
...
var HTMLschoolName = '<a href="%data1%">%data2%';
...
var HTMLonlineCourseSchool = '<a href="%data1%">%data2%';
